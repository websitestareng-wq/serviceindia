...
onChange={(e) => {
  ...
  setFilters((prev) => ({
    ...
    search: value.trim(),
        ...
        placeholder="Search by date, particulars, voucher type, voucher no..."
        className="h-10.5 w-full rounded-[18px] border border-slate-200 bg-white pl-10 pr-3 text-sm text-slate-700 outline-none transition-all duration-200 placeholder:text-slate-400 focus:border-blue-400 focus:ring-4 focus:ring-blue-100"
      />
    </div>
  </div>
