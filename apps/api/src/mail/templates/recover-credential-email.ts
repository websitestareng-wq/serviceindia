...
">
  ...
  ">
    <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse:collapse; width:100%;">
      <tr>
        <td style="width:42%; padding:14px 16px; border-bottom:1px solid #bfdbfe; font-weight:700; color:#1f2937; vertical-align:top;">
          Name
        </td>
        <td style="padding:14px 16px; border-bottom:1px solid #bfdbfe; color:#111827; vertical-align:top;">
          ${userName}
        </td>
      </tr>
      ...
      <tr>
        ...
        <td style="padding:14px 16px; border-bottom:1px solid #bfdbfe; color:#111827; vertical-align:top; word-break:break-all; overflow-wrap:anywhere;">
          ${loginEmail}
        </td>
      </tr>
  ...
  <p style="margin:0 0 16px 0;">
    ...
    <a href="${loginUrl}" target="_blank" style="color:#1d4ed8; text-decoration:none;">
      ${loginUrl}
    </a>
  </p>
  ...
  <p style="margin:0 0 16px 0;">
    If you did not request this recovery, please contact SERVICE INDIA support immediately.
  </p>
  ...
  <div style="margin-top:20px; padding-top:16px; border-top:1px solid #e5e7eb;">
    ...
    <p style="margin:0 0 6px 0;">
      Email:
      <a href="mailto:corporate@serviceind.co.in" target="_blank" style="color:#1d4ed8; text-decoration:none;">
    ...
    <p style="margin:0 0 6px 0;">
      Website:
      <a href="https://www.serviceind.co.in" target="_blank" style="color:#1d4ed8; text-decoration:none;">
